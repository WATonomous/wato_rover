...
def generate_launch_description():
    ...
    camera_processor_pkg_prefix = get_package_share_directory("camera_processor")
    camera_processor_param_file = os.path.join(
        camera_processor_pkg_prefix, "config", "params.yaml"
    )

    camera_processor_param = DeclareLaunchArgument(
        "camera_processor_param_file",
        default_value=camera_processor_param_file,
    ...
    camera_processor_node = Node(
        ...
        parameters=[LaunchConfiguration("camera_processor_param_file")],
    )
    ld.add_action(camera_processor_param)
