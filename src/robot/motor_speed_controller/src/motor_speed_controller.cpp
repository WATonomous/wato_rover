...
: Node("motor_speed_controller")
{
  ...
  odrive_pub_ = this->create_publisher<std_msgs::msg::String>("/OdriveJsonSub", 10);
}
...
void MotorSpeedController::arcade_callback(const drivetrain_msgs::msg::ArcadeSpeed arcade_msg)
{
  ...
  drivetrain_msgs::msg::MotorSpeeds motor_speeds_msg =
    MotorSpeedController::compute_motor_speeds(arcade_left, arcade_right);
...
void MotorSpeedController::publish_speeds_odrive(drivetrain_msgs::msg::MotorSpeeds speeds)
{
  ...
  req_json["Payload"] = {
    {"1", speeds.m1}, {"2", speeds.m2}, {"3", speeds.m3}, {"4", speeds.m4}, {"5", speeds.m5}, {"6", speeds.m6}};
