...
Matrix6x6::Matrix6x6(const Matrix6x6& other) : data_(other.data_) {}
...
void ExtendedKalmanFilter::predict(double vx, double vy, double omega, double dt,
                                   double process_noise_pos, double process_noise_theta,
...
void ExtendedKalmanFilter::getState(double& x, double& y, double& theta,
...
void ExtendedKalmanFilter::getOdometry(nav_msgs::msg::Odometry& odom_msg,
...
Matrix6x6 ExtendedKalmanFilter::computeProcessJacobian(double vx, double vy,
